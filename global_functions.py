...
ban_msg = ["flew to close to the radar and got banned", "messed up bad and got banned", "has been struck by the BAN HAMMER", "annoyed some staff and got banned", "wanted to see what would happen if you broke rules and got banned", "tried to dodge the ban hammer :rofl:"]


kick_msg = ["got booted and got kicked?", "got kicked, imagine getting kicked...", "got kicked... I ran out of jokes"]

work_list = ["Discord", "Microsoft", "Apple", "a Police Station", "Youtube", "Google"]

options = ['uber', 'taxi', 'doorstep', 'locker', 'grass', 'couch', 'house', 'bush', 'street', 'lake']

choices = ['get no', 'gained']
#test

bank_memberships = [
  { "name": "Basic Membership - ``$100,000``", "description": "Store up to $100,000 in your bank" },
  { "name": "Silver Membership - ``$500,000``", "description": "Store up to $250,000 in your bank" },
  { "name": "Diamond Membership - ``$1,000,000``", "description": "Store up to $500,000 in your bank!" },
  { "name": "Magical Membership - ``$1,500,000``", "description": "Store up to $1,000,000 in your bank!" },
  { "name": "Epik Membership - ``$2,500,000``", "description": "Store up to $2,000,000 in your bank!" },
  { "name": "Glow Membership - ``$5,000,000``", "description": "Store up to $10,000,000 in your bank!" }
]

bank_membership_conversions = [
  { "name": "basic membership", "nickname": "basic", "price": 100_000, "amount": 100_000 },
  { "name": "silver membership", "nickname": "epic", "price": 500_000, "amount": 250_000 },
  { "name": "diamond membership", "nickname": "magical", "price": 1_000_000, "amount": 500_000 },
  { "name": "magical membership", "nickname": "diamond", "price": 1_500_000, "amount": 1_000_000 },
  { "name": "epik membership", "nickname": "silver", "price": 2_500_000, "amount": 2_000_000 },
  { "name": "glow membership", "nickname": "exotic", "price": 5_000_000, "amount": 10_000_000 }
]
