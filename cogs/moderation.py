...
class Moderation(commands.Cog):
    ...
    async def toggle(self, ctx):
        ...
        try:
            ...
            return await ctx.send(embed=embed)
        embed = Embed(
            title=f"My Starboard Settings For {ctx.guild.name}",
            color=Color.green()
    ...
    async def channel(self, ctx):
        ...
        await ctx.send(
            embed=Embed(
                title=f"My Starboard Channel Settings For {ctx.guild.name}",
                color=Color.green(),
    ...
    async def minimum_stars(self, ctx):
        ...
        await ctx.send(
            embed=Embed(
                title=f"My Starboard Minimum Stars Settings For {ctx.guild.name}",
                color=Color.green(),
            )
        )
